pub mod Common {
    ...
    pub fn method10(
        ...
        let v502: Common::US2 = defaultValue(Common::US2::US2_1, map(Common::method11(), v5));
        let v515: u64 = (match &v502 {
            Common::US2::US2_0(v502_0_0) => {
                (v485)
                    - (match &v502 {
                        Common::US2::US2_0(x) => x.clone(),
                        _ => unreachable!(),
    ...
    pub fn method19(v0_1: i32, v1_1: LrcPtr<Exception>) -> string {
        ...
        let v117: () = {
            Common::closure11(v3.clone(), fable_library_rust::String_::fromString(v86), ());
            ()
        };
        let v127: () = {
            Common::closure11(v3.clone(), string(" }"), ());
