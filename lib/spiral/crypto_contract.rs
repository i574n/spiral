pub mod Crypto {
    ...
    pub fn method8(v0_1: string) -> string {
        panic!(
            ...
            sprintf!(
                ...
                Crypto::US4::US4_4(Crypto::US3::US3_2),
                v0_1
            ),
        )
    }
    ...
    pub fn method12(
        ...
        let v594: Crypto::US2 = defaultValue(Crypto::US2::US2_1, map(Crypto::method13(), v5));
    ...
    pub fn method21(v0_1: string) {
        ...
        let v41: LrcPtr<Crypto::Mut4> = patternInput.3.clone();
        let v60: () = {
