pub mod Date_time {
    ...
    pub fn method0(v0_1: Guid, v1_1: DateTime) -> Guid {
        ...
        let v1395: Date_time::US0 =
            defaultValue(Date_time::US0::US0_1, map(Date_time::method1(), v1378));
        let v1415: Date_time::US1 = match &v1395 {
            Date_time::US0::US0_0(v1395_0_0) => {
        ...
        let v1419: string = match &v1415 {
            Date_time::US1::US1_0(v1415_0_0) => match &v1415 {
        ...
        let v1656: string = Date_time::method2();
