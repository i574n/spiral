pub mod Date_time {
    ...
    pub fn method0(v0_1: Guid, v1_1: DateTime) -> Guid {
        ...
        let v1772: Date_time::US0 =
            defaultValue(Date_time::US0::US0_1, map(Date_time::method1(), v1747));
        let v1792: Date_time::US1 = match &v1772 {
            Date_time::US0::US0_0(v1772_0_0) => {
        ...
        let v1796: string = match &v1792 {
            Date_time::US1::US1_0(v1792_0_0) => match &v1792 {
        ...
        let v2056: string = Date_time::method2();
        ...
        let v2420: string = toString(v0_1);
