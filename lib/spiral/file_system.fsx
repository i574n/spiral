...
and method80 (v0 : System.Guid, v1 : System.DateTime) : System.Guid =
    ...
    let v860 : (chrono_DateTime<chrono_Utc> -> US13) = method81()
    let v861 : US13 option = v857 |> Option.map v860 
    let v881 : US13 = US13_1
    let v882 : US13 = v861 |> Option.defaultValue v881 
    let v902 : US5 =
        match v882 with
        | US13_1 -> (* None *)
            US5_1
    ...
    let v1743 : (chrono_DateTime<chrono_Utc> -> US13) = method81()
    let v1744 : US13 option = v1740 |> Option.map v1743 
    let v1764 : US13 = US13_1
    let v1765 : US13 = v1744 |> Option.defaultValue v1764 
    let v1785 : US5 =
        match v1765 with
        | US13_1 -> (* None *)
            US5_1
