...
and method131 (v0 : string) : unit =
    ...
    try
        ...
        let v29 : US16 = method126(v28, v25)
        let v77 : US5 =
            match v29 with
            | US16_1(v32) -> (* Error *)
                let v33 : unit = ()
