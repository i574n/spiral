...
def closure15(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow329(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure17(unit_var: None, v0_1: str) -> Callable[[str], Async[None]]:
    def _arrow330(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[None]:
...
def method39(v0_1: str, v1_1: str) -> Async[bool]:
    def _arrow332(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[bool]:
        if method33(v0_1) == False:
            return singleton.Return(False)

        else: 
            v61: Async[str] = method31(v0_1)
            def _arrow331(_arg: str) -> Async[bool]:
                v63: bool = v1_1 == _arg
                return singleton.Return(v63)

            return singleton.Bind(v61, _arrow331)
...
def method37(v0_1: str, v1_1: str) -> Async[None]:
    def _arrow337(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[None]:
        v51: Async[bool] = method38(v0_1, v1_1)
        def _arrow336(_arg: bool) -> Async[None]:
            v53: bool = _arg == False
            def _arrow334(__unit: None=None) -> Async[None]:
                v54: Async[None] = method35(v0_1, v1_1)
                def _arrow333(__unit: None=None) -> Async[None]:
                    return singleton.Zero()

                return singleton.Bind(v54, _arrow333)

            def _arrow335(__unit: None=None) -> Async[None]:
                return singleton.Zero()

            return singleton.Combine(_arrow334() if v53 else singleton.Zero(), singleton.Delay(_arrow335))

        return singleton.Bind(v51, _arrow336)
...
def method43(__unit: None=None) -> Callable[[std_io_error], str]:
    def _arrow339(v: std_io_error) -> str:
...
def method45(__unit: None=None) -> Callable[[], US9]:
    def _arrow340(__unit: None=None) -> US9:
    ...
    def _arrow347(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[int64]:
        ...
        def _arrow346(_arg: Exception) -> Async[int64]:
            ...
            def _arrow345(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v2750, _arrow344)

            return singleton.Combine(_arrow343() if v2671 else singleton.Zero(), singleton.Delay(_arrow345))
...
def method55(v0_1: str, v1_1: str, v2_1: int64) -> Async[int64]:
    def _arrow353(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> Async[int64]:
        ...
        def _arrow352(_arg: Exception) -> Async[int64]:
            ...
            def _arrow351(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v1574, _arrow350)

            return singleton.Combine(_arrow349() if v1494 else singleton.Zero(), singleton.Delay(_arrow351))
...
def method66(__unit: None=None) -> Callable[[Exception], US10]:
    def _arrow356(v: Exception) -> US10:
...
def method64(v0_1: Async[Any]) -> Async[US10]:
    def _arrow358(__unit: None=None, v0_1: Any=v0_1) -> Async[US10]:
        def _arrow357(_arg: Any) -> Async[US10]:
...
def method67(v0_1: Async[US10]) -> Async[US11]:
    def _arrow360(__unit: None=None, v0_1: Any=v0_1) -> Async[US11]:
        def _arrow359(_arg: US10) -> Async[US11]:
            v74: US10 = _arg
...
def method68(v0_1: int, v1_1: Async[US11]) -> Async[US2]:
    def _arrow362(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[US2]:
        def _arrow361(_arg: US11) -> Async[US2]:
            v1019: US11 = _arg
            v1143: US2
            if v1019.tag == 0:
        ...
        return singleton.Bind(v1_1, _arrow361)
...
def method74(v0_1: Async[str]) -> Async[str | None]:
    def _arrow366(__unit: None=None, v0_1: Any=v0_1) -> Async[str | None]:
        def _arrow365(_arg: str) -> Async[str | None]:
...
def method61(v0_1: str, v1_1: int64) -> Async[str | None]:
    def _arrow372(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[str | None]:
        def _arrow370(__unit: None=None) -> Async[str | None]:
            ...
            def _arrow368(__unit: None=None) -> Async[None]:
                ...
                return singleton.Bind(v1692, _arrow367)
            ...
            return singleton.Combine(_arrow368() if v1675 else singleton.Zero(), singleton.Delay(_arrow369))

        def _arrow371(_arg_1: Exception) -> Async[str | None]:
        ...
        return singleton.TryWith(singleton.Delay(_arrow370), _arrow371)
...
def method79(__unit: None=None) -> Callable[[chrono_date_time_1[chrono_utc]], US12]:
    def _arrow373(v: chrono_date_time_1[chrono_utc]) -> US12:
...
def method90(__unit: None=None) -> Callable[[std_io_error], std_string_string]:
    def _arrow374(v: std_io_error) -> std_string_string:
...
def method91(__unit: None=None) -> Callable[[], US13]:
    def _arrow375(__unit: None=None) -> US13:
...
def method92(__unit: None=None) -> Callable[[std_string_string], US13]:
    def _arrow376(v: std_string_string) -> US13:
...
def method105(v0_1: int, v1_1: str, v2_1: int) -> Callable[[str], str]:
    def _arrow382(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> str:
...
def method109(__unit: None=None) -> Callable[[std_path_path_buf], US14]:
    def _arrow383(v: std_path_path_buf) -> US14:
...
def closure55(v0_1: str, v1_1: uint8) -> Callable[[str], FSharpResult_2[std_path_path_buf, std_io_error]]:
    def _arrow386(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1) -> FSharpResult_2[std_path_path_buf, std_io_error]:
...
def method123(__unit: None=None) -> Callable[[std_path_path_buf], US15]:
    def _arrow387(v: std_path_path_buf) -> US15:
...
def method106(v0_1: str) -> str:
    if v0_1 == "":
        ...
        if len(v69) < 2:
            ...
            def _arrow388(__unit: None=None, v0_1: Any=v0_1) -> str:
                _arg: str = v69[0]
                return _arg.lower()

            return replace(concat(_arrow388(), *v69[1:len(v69)]), "\\", "/")
...
def method135(v0_1: US16, v1_1: str, v2_1: str) -> US17:
    ...
    def _arrow389(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> bool:
        return closure62(None, v)

    def _arrow390(v_1: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> bool:
        return closure63(None, v_1)

    return method136(v1_1, v2_1, v3, _arrow389 if v3 else _arrow390)
...
def closure61(unit_var: None, unit_var_1: None) -> str:
    ...
    def _arrow391(__unit: None=None, unit_var: Any=unit_var, unit_var_1: Any=unit_var_1) -> str:
    ...
    return method86(_arrow391() if ("deps" == method20(v17_1)) else v17_1, "polyglot")
...
def closure67(unit_var: None, v0_1: bool) -> None:
    ...
    v3 = None
    pattern_input: tuple[Mut0, Mut1, Mut2, Mut3, Mut4, int64 | None] = value_10(TraceState_trace_state())
    def _arrow392(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure65(None, v)

    def _arrow393(v_1: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure2(None, v_1)

    v37_1: Callable[[str], None] = _arrow392 if v0_1 else _arrow393
...
def method141(v0_1: str, v1_1: str) -> None:
    ...
    def _arrow394(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> bool:
        v14: FSharpResult_2[std_path_path_buf, std_io_error] = method107(v1_1)
        return True

    if _arrow394() if method10(v1_1) else False:
        method9(True, v1_1)
...
def closure70(unit_var: None, v0_1: str) -> Callable[[str], str]:
    def _arrow396(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def _arrow397(__unit: None=None) -> None:
    closure0(None, None)


v1: Callable[[], None] = _arrow397
...
v16: Callable[[str], Async[int64]] = _arrow399

def delete_directory_async(x: str) -> Async[int64]:
    return v16(x)


def _arrow400(v: US6) -> Callable[[str], Async[int64]]:
    return closure10(None, v)


v17: Callable[[US6, str], Async[int64]] = _arrow400
...
v18: Callable[[str], Async[int64]] = _arrow401

def wait_for_file_access_read(x: str) -> Async[int64]:
    return v18(x)


def _arrow402(v: str) -> Async[str]:
    return closure14(None, v)


v19: Callable[[str], Async[str]] = _arrow402

def read_all_text_async(x: str) -> Async[str]:
    return v19(x)


def _arrow403(v: str) -> Callable[[str], bool]:
    return closure15(None, v)


v20: Callable[[str, str], bool] = _arrow403

def file_exists_content(x: str) -> Callable[[str], bool]:
    return v20(x)


def _arrow404(v: str) -> Callable[[str], Async[None]]:
    return closure17(None, v)


v21: Callable[[str, str], Async[None]] = _arrow404
...
v22: Callable[[str, str], Async[None]] = _arrow405

def write_all_text_exists(x: str) -> Callable[[str], Async[None]]:
    return v22(x)


def _arrow406(v: str) -> Async[int64]:
    return closure21(None, v)


v23: Callable[[str], Async[int64]] = _arrow406

def delete_file_async(x: str) -> Async[int64]:
    return v23(x)


def _arrow407(v: str) -> Callable[[str], Async[int64]]:
    return closure27(None, v)


v24: Callable[[str, str], Async[int64]] = _arrow407

def move_file_async(x: str) -> Callable[[str], Async[int64]]:
    return v24(x)


def _arrow408(v: str) -> Async[str | None]:
    return closure30(None, v)


v25: Callable[[str], Async[str | None]] = _arrow408

def read_all_text_retry_async(x: str) -> Async[str | None]:
    return v25(x)


def _arrow409(__unit: None=None) -> str:
    return closure36(None, None)


v26: Callable[[], str] = _arrow409

def create_temp_path(__unit: None=None) -> str:
    return v26(None)


def _arrow410(__unit: None=None) -> tuple[str, IDisposable]:
    return closure38(None, None)


v27: Callable[[], tuple[str, IDisposable]] = _arrow410

def create_temp_dir(__unit: None=None) -> tuple[str, IDisposable]:
    return v27(None)


def _arrow411(v: str) -> tuple[str, IDisposable]:
    return closure47(None, v)


v28: Callable[[str], tuple[str, IDisposable]] = _arrow411
...
v29: Callable[[], str] = _arrow412

def get_source_directory(__unit: None=None) -> str:
    return v29(None)


def _arrow413(v: str) -> str:
    return closure50(None, v)


v30: Callable[[str], str] = _arrow413
...
v31: Callable[[str], str] = _arrow414
...
v32: Callable[[str], str] = _arrow415
...
v33: Callable[[str], str] = _arrow416

def new_file_uri(x: str) -> str:
    return v33(x)


def _arrow417(__unit: None=None) -> str:
    return closure61(None, None)


v34: Callable[[], str] = _arrow417

def get_workspace_root(__unit: None=None) -> str:
    return v34(None)


def _arrow418(v: str) -> None:
    closure65(None, v)


v35: Callable[[str], None] = _arrow418

def trace_file(x: str) -> None:
    v35(x)


def _arrow419(v: bool) -> None:
    closure67(None, v)


v36: Callable[[bool], None] = _arrow419

def init_trace_file(x: bool) -> None:
    v36(x)


def _arrow420(v: str) -> Callable[[str], None]:
    return closure68(None, v)


v37: Callable[[str, str], None] = _arrow420

def link_directory(x: str) -> Callable[[str], None]:
    return v37(x)


def _arrow421(v: str) -> Callable[[str], str]:
    return closure70(None, v)


v38: Callable[[str, str], str] = _arrow421
