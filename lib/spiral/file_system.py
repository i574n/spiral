...
def method1(__unit: None=None) -> tuple[US1, US2]:
    ...
    return (US1(0, v41.fields[0]) if (v41.tag == 0) else _arrow318(), US2(1) if (method2("AUTOMATION") != "True") else US2(0, from_value(ticks_1(now()), False)))
...
def method11(v0_1: US0) -> bool:
    ...
    if pattern_input[2].l0 == False:
        ...
        return find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr319())) >= find(v42, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr320()))
...
def method8(v0_1: str, v1_1: int64) -> Async[int64]:
    def _arrow327(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[int64]:
        ...
        def _arrow326(_arg: Exception) -> Async[int64]:
            ...
            def _arrow325(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v1989, _arrow324)

            return singleton.Combine(_arrow323() if v1888 else singleton.Zero(), singleton.Delay(_arrow325))
...
def method27(v0_1: US6, v1_1: str, v2_1: int64, v3: US8, v4: US7) -> Async[int64]:
    def _arrow334(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3: Any=v3, v4: Any=v4) -> Async[int64]:
        ...
        def _arrow333(_arg_1: Exception) -> Async[int64]:
            ...
            def _arrow332(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v2980, _arrow331)

            return singleton.Combine(_arrow330() if v2879 else singleton.Zero(), singleton.Delay(_arrow332))
...
def closure10(unit_var: None, v0_1: US6) -> Callable[[str], Async[int64]]:
    def _arrow335(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[int64]:
...
def method33(v0_1: str, v1_1: int64) -> Async[str]:
    def _arrow339(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[str]:
        ...
        def _arrow338(_arg: Exception) -> Async[str]:
            ...
            return singleton.Bind(v2596, _arrow337)
...
def closure16(unit_var: None, v0_1: str) -> Callable[[str], bool]:
    def _arrow340(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> bool:
...
def closure18(unit_var: None, v0_1: str) -> Callable[[str], Async[None]]:
    def _arrow341(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[None]:
...
def method44(v0_1: str, v1_1: str) -> Async[bool]:
    def _arrow343(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[bool]:
        if method38(v0_1) == False:
            ...
            return singleton.Bind(v70, _arrow342)
...
def method42(v0_1: str, v1_1: str) -> Async[None]:
    def _arrow348(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[None]:
        ...
        def _arrow347(_arg: bool) -> Async[None]:
            ...
            def _arrow345(__unit: None=None) -> Async[None]:
                ...
                return singleton.Bind(v63, _arrow344)

            def _arrow346(__unit: None=None) -> Async[None]:
                return singleton.Zero()

            return singleton.Combine(_arrow345() if v62 else singleton.Zero(), singleton.Delay(_arrow346))

        return singleton.Bind(v60, _arrow347)
...
def closure20(unit_var: None, v0_1: str) -> Callable[[str], Async[None]]:
    def _arrow349(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[None]:
...
def method47(v0_1: str, v1_1: int64) -> Async[int64]:
    def _arrow358(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[int64]:
        ...
        def _arrow357(_arg: Exception) -> Async[int64]:
            ...
            def _arrow356(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v3339, _arrow355)

            return singleton.Combine(_arrow354() if v3238 else singleton.Zero(), singleton.Delay(_arrow356))
...
def method60(v0_1: str, v1_1: str, v2_1: int64) -> Async[int64]:
    def _arrow364(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> Async[int64]:
        ...
        def _arrow363(_arg: Exception) -> Async[int64]:
            ...
            def _arrow362(__unit: None=None) -> Async[int64]:
                ...
                return singleton.Bind(v1957, _arrow361)

            return singleton.Combine(_arrow360() if v1855 else singleton.Zero(), singleton.Delay(_arrow362))
...
def closure28(unit_var: None, v0_1: str) -> Callable[[str], Async[int64]]:
    def _arrow365(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> Async[int64]:
...
def method69(v0_1: Async[Any]) -> Async[US10]:
    def _arrow369(__unit: None=None, v0_1: Any=v0_1) -> Async[US10]:
...
def method72(v0_1: Async[US10]) -> Async[US11]:
    def _arrow371(__unit: None=None, v0_1: Any=v0_1) -> Async[US11]:
...
def method73(v0_1: int, v1_1: Async[US11]) -> Async[US2]:
    def _arrow373(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[US2]:
        ...
        return singleton.Bind(v1_1, _arrow372)
...
def method68(v0_1: Async[int64], v1_1: int) -> Async[US2]:
    def _arrow375(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[US2]:
        ...
        return singleton.Bind(v542, _arrow374)
...
def method78(v0_1: Async[str]) -> Async[str | None]:
    def _arrow377(__unit: None=None, v0_1: Any=v0_1) -> Async[str | None]:
        def _arrow376(_arg: str) -> Async[str | None]:
            return singleton.Return(_arg)

        return singleton.Bind(v0_1, _arrow376)
...
def method66(v0_1: str, v1_1: int64) -> Async[str | None]:
    def _arrow383(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> Async[str | None]:
        def _arrow381(__unit: None=None) -> Async[str | None]:
            ...
            def _arrow379(__unit: None=None) -> Async[None]:
                ...
                return singleton.Bind(v2132, _arrow378)
            ...
            return singleton.Combine(_arrow379() if v2108 else singleton.Zero(), singleton.Delay(_arrow380))
...
def method109(v0_1: int, v1_1: str, v2_1: int) -> Callable[[str], str]:
    def _arrow393(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> str:
...
def closure54(v0_1: str, v1_1: uint8) -> Callable[[str], FSharpResult_2[std_path_path_buf, std_io_error]]:
    def _arrow396(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1) -> FSharpResult_2[std_path_path_buf, std_io_error]:
...
def closure56(v0_1: str, v1_1: uint8) -> Callable[[str], FSharpResult_2[std_path_path_buf, std_io_error]]:
    def _arrow397(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1) -> FSharpResult_2[std_path_path_buf, std_io_error]:
...
def method110(v0_1: str) -> str:
    if v0_1 == "":
        ...
        if len(v85) < 2:
            ...
            def _arrow399(__unit: None=None, v0_1: Any=v0_1) -> str:
                _arg: str = v85[0]
                return _arg.lower()

            return replace(concat(_arrow399(), *v85[1:len(v85)]), "\\", "/")
...
def method139(v0_1: US16, v1_1: str, v2_1: str) -> US17:
    ...
    def _arrow400(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> bool:
        return closure63(None, v)

    def _arrow401(v_1: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> bool:
        return closure64(None, v_1)

    return method140(v1_1, v2_1, v3, _arrow400 if v3 else _arrow401)
...
def closure62(unit_var: None, unit_var_1: None) -> str:
    ...
    return method90(_arrow402() if ("deps" == method20(v17_1)) else v17_1, "polyglot")
...
def closure68(unit_var: None, v0_1: bool) -> None:
    ...
    v3 = None
    pattern_input: tuple[Mut0, Mut1, Mut2, Mut3, Mut4, int64 | None] = value_10(TraceState_trace_state())
    def _arrow403(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure66(None, v)

    def _arrow404(v_1: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure2(None, v_1)

    v44: Callable[[str], None] = _arrow403 if v0_1 else _arrow404
...
def method145(v0_1: str, v1_1: str) -> None:
    ...
    def _arrow405(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1) -> bool:
        v16: FSharpResult_2[std_path_path_buf, std_io_error] = method111(v1_1)
        return True

    if _arrow405() if method10(v1_1) else False:
        method9(True, v1_1)
...
def closure69(unit_var: None, v0_1: str) -> Callable[[str], None]:
    def _arrow406(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> None:
        closure70(v0_1, v)
...
def closure71(unit_var: None, v0_1: str) -> Callable[[str], str]:
    def _arrow407(v: str, unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
v17: Callable[[str], Async[int64]] = _arrow410
...
v18: Callable[[US6, str], Async[int64]] = _arrow411
...
v19: Callable[[str], Async[int64]] = _arrow412
...
v20: Callable[[str], Async[str]] = _arrow413
...
v21: Callable[[str, str], bool] = _arrow414
...
v22: Callable[[str, str], Async[None]] = _arrow415
...
v23: Callable[[str, str], Async[None]] = _arrow416
...
v24: Callable[[str], Async[int64]] = _arrow417
...
v25: Callable[[str, str], Async[int64]] = _arrow418
...
v26: Callable[[str], Async[str | None]] = _arrow419
...
v28: Callable[[], tuple[str, IDisposable]] = _arrow421
...
v29: Callable[[str], tuple[str, IDisposable]] = _arrow422
...
v31: Callable[[str], str] = _arrow424
...
v32: Callable[[str], str] = _arrow425
...
v33: Callable[[str], str] = _arrow426
...
v34: Callable[[str], str] = _arrow427
...
v36: Callable[[str], None] = _arrow429
...
v37: Callable[[bool], None] = _arrow430
...
v38: Callable[[str, str], None] = _arrow431
...
v39: Callable[[str, str], str] = _arrow432
