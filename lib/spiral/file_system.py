...
def method106(v0_1: str) -> str:
    if v0_1 == "":
        ...
        if len(v69) < 2:
            ...
            return replace(concat(_arrow416(), *v69[1:len(v69)]), "\\", "/")
...
def method131(v0_1: str, v1_1: str) -> str:
    v3: Mut3 = Mut3(method18())
    v10: None
    closure6(v3, "{ ", None)
    v10 = None
...
def method130(v0_1: Mut0, v1_1: Mut1, v2_1: Mut2, v3: Mut3, v4: Mut4, v5: int64 | None, v6: str, v7: str, v8: str, v9: str) -> str:
    v10: str = method131(v8, v9)
    return method23(((((((((("" + v6) + " ") + v7) + " #") + str(v0_1.l0)) + " ") + "file_system.get_workspace_root") + " / ") + v10) + "")


def closure60(v0_1: str, v1_1: str, unit_var: None) -> None:
    if method11(US0(3)):
        v6: None
        closure0(None, None)
        v6 = None
...
def method127(v0_1: str) -> US5:
    v4: US16 = method128(method86("spiral", "workspace"), v0_1)
    if v4.tag == 0:
        return US5(0, method106(v4.fields[0]))

    else: 
        v11: None
        closure60(v0_1, v4.fields[0], None)
        v11 = None
        return US5(1)
...
def closure59(unit_var: None, unit_var_1: None) -> str:
    v1_1: US5 = method127("c:\\home\\git\\polyglot\\deps\\spiral\\lib\\spiral")
    v7: US5 = US5(0, v1_1.fields[0]) if (v1_1.tag == 0) else method127(method132())
    v11: str
    if v7.tag == 0:
        v11 = v7.fields[0]
    ...
    def _arrow417(__unit: None=None, unit_var: Any=unit_var, unit_var_1: Any=unit_var_1) -> str:
        v18_1: US5 = method127(value_10(method113(v11)))
        if v18_1.tag == 0:
    ...
    return method86(_arrow417() if ("deps" == method20(v11)) else v11, "polyglot")
