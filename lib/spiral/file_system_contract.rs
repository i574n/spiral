pub mod File_system {
    ...
    pub fn method24(v0_1: string) {
        ...
        let patternInput: (
            ...
            .clone()
            .unwrap();
        let v27_1: LrcPtr<File_system::Mut3> = patternInput.3.clone();
        let v44: () = {
            File_system::closure7(patternInput.0.clone(), ());
            ()
        };
        let v60: string = if (v27_1.l0.get().clone()) == string("") {
            v0_1.clone()
        } else {
            if (v0_1.clone()) == string("") {
                ...
                append(
                    (append((v27_1.l0.get().clone()), string("\n"))),
                    (v0_1.clone()),
                )
            }
        };
    ...
    pub fn method36(v0_1: i64, v1_1: string, v2_1: LrcPtr<Exception>) -> string {
        ...
        let v130: std::string::String = format!("{:#?}", v2_1);
        let v161: () = {
    ...
    pub fn method49(v0_1: std::io::Error) -> string {
        ...
        let v17_1: std::string::String = format!("{:#?}", v0_1);
        let v48: () = {
            File_system::closure6(
                v2_1.clone(),
                fable_library_rust::String_::fromString(v17_1),
                (),
            );
            ()
        };
    ...
    pub fn method52() -> string {
        ...
        let v97: &str = inline_colorization::color_bright_red;
        let v108: &str = &*v8;
        let v132: &str = inline_colorization::color_reset;
        let v134: std::string::String = format!("{}{}{}", v97, v108, v132);
        fable_library_rust::String_::fromString(v134)
    ...
    pub fn closure38(unitVar: (), v0_1: Option<()>) -> File_system::US12 {
        File_system::US12::US12_0(v0_1)
    }
    pub fn method83() -> Func1<Option<()>, File_system::US12> {
    ...
    pub fn method98(v0_1: string, v1_1: std::string::String) -> string {
        ...
        let v122: () = {
            File_system::closure6(v3.clone(), fable_library_rust::String_::fromString(v91), ());
            ()
        };
        let v133: () = {
            File_system::closure6(v3.clone(), string(" }"), ());
    ...
    pub fn closure47(v0_1: string, unitVar: ()) {
        ...
        let v16: Arc<Async<()>> = fable_library_rust::Native_::getZero();
        fable_library_rust::Native_::getZero::<()>();
        ()
    }
    ...
    pub fn method116(
        ...
        if (v2_1) >= 11_u8 {
            ...
            let v44: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v33_1);
            Err(v44)
        } else {
            if let File_system::US5::US5_0(v25_1_0_0) = &v25_1 {
                if (v4.clone()) != string("") {
                    ...
                    match &v111 {
                        File_system::US14::US14_0(v111_0_0) => {
                            ...
                            let v163: &str = &*v152;
                            let v196: std::string::String = String::from(v163);
                            let v229: std::path::PathBuf = std::path::PathBuf::from(v196);
                            Ok(v229)
                        }
                ...
                let v386: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v375);
                Err(v386)
            }
        }
    }
    pub fn method115(
        ...
        let v99: Result<std::path::PathBuf, std::io::Error> = std::fs::read_link(&*v2_1.clone());
        let v100 = File_system::method48();
        let v113: Result<std::path::PathBuf, string> = v99.map_err(|x| v100(x));
        let v116 = File_system::method113();
        ...
        match &v119 {
            ...
            File_system::US14::US14_1(v119_1_0) => File_system::method116(
                v0_1.clone(),
                Func2::new({
                    let v0_1 = v0_1.clone();
    ...
    pub fn method119(
        ...
        if (v2_1) >= 11_u8 {
            ...
            let v43: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v32_1);
            Err(v43)
        } else {
                ...
                if (v0_1.clone()) != string("") {
                    ...
                    match &v110 {
                        File_system::US14::US14_0(v110_0_0) => {
                            ...
                            let v228: std::path::PathBuf = std::path::PathBuf::from(v195);
                            Ok(v228)
                        }
                ...
                let v374: string =
                    append(string("file_system.read_link / run / The file or directory is not a reparse point. / "),
                           sprintf!("path: {} / error: {} / path\': {} / name: {}",
                                    ...
                                    v4.clone()));
                let v385: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v374);
                Err(v385)
            }
        }
    }
    pub fn method112(v0_1: string, v1_1: u8) -> Result<std::path::PathBuf, std::io::Error> {
        let v98: Result<std::path::PathBuf, std::io::Error> = std::fs::read_link(&*v0_1.clone());
        let v99 = File_system::method48();
        let v112: Result<std::path::PathBuf, string> = v98.map_err(|x| v99(x));
        let v115 = File_system::method113();
        ...
        match &v118 {
            ...
            File_system::US14::US14_1(v118_1_0) => File_system::method119(
                v0_1.clone(),
                Func2::new({
                    let v0_1 = v0_1.clone();
                    move |b0: u8, b1: string| {
    ...
    pub fn method110(v0_1: string) -> string {
        if (v0_1.clone()) == string("") {
            ...
            let v37_1: File_system::US15 = defaultValue(
                File_system::US15::US15_1,
                map(File_system::method127(), v11),
            );
