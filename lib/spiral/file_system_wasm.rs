pub mod File_system {
    ...
    pub fn method2(v0: string) -> string {
        panic!(
            ...
            sprintf!(
                ...
                File_system::US4::US4_4(File_system::US3::US3_1),
                v0
            ),
        )
    }
    ...
    pub fn method11(
        ...
        let v606: string = File_system::method13();
    ...
    pub fn method15() -> string {
        let v43_1: &str = inline_colorization::color_bright_blue;
        let v52_1: std::string::String = String::from(v43_1);
        let v139: string = append(
            (fable_library_rust::String_::fromString(v52_1)),
    ...
    pub fn method31() -> string {
        let v43_1: &str = inline_colorization::color_bright_black;
        let v52_1: std::string::String = String::from(v43_1);
        let v139: string = append(
            (fable_library_rust::String_::fromString(v52_1)),
    ...
    pub fn method46(v0: std::io::Error) -> string {
        ...
        let v13: std::string::String = format!("{:#?}", v0);
        let v56: () = {
            File_system::closure6(v2.clone(), fable_library_rust::String_::fromString(v13), ());
            ()
        };
        v2.l0.get().clone()
    }
    ...
    pub fn method49() -> string {
        let v43_1: &str = inline_colorization::color_bright_red;
        let v52_1: std::string::String = String::from(v43_1);
        let v139: string = append(
            (fable_library_rust::String_::fromString(v52_1)),
    ...
    pub fn method52() -> string {
        let v43_1: &str = inline_colorization::color_yellow;
        let v52_1: std::string::String = String::from(v43_1);
        let v139: string = append(
            (fable_library_rust::String_::fromString(v52_1)),
    ...
    pub fn method83(v0: Guid, v1: DateTime) -> Guid {
        ...
        let v1745: i64 = ((v1645.ticks()) - (v1635.ticks())) / 10_i64;
        let v1747: Option<chrono::DateTime<chrono::Utc>> =
            chrono::DateTime::from_timestamp_micros(v1745);
        let v1772: File_system::US13 = defaultValue(
            File_system::US13::US13_1,
            map(File_system::method84(), v1747),
        );
        let v1792: File_system::US5 = match &v1772 {
            File_system::US13::US13_0(v1772_0_0) => {
                let v1778: chrono::NaiveDateTime = match &v1772 {
                    File_system::US13::US13_0(x) => x.clone(),
                    _ => unreachable!(),
                }
                .clone()
                .naive_utc();
                let v1780: chrono::DateTime<chrono::Local> =
                    chrono::offset::TimeZone::from_utc_datetime(&chrono::Local, &v1778);
                let v1782: string = string("r#\"%Y%m%d-%H%M-%S%f\"#");
                let v1783: &str = r#"%Y%m%d-%H%M-%S%f"#;
                let v1785: std::string::String = v1780.format(v1783).to_string();
                let v1787: string = fable_library_rust::String_::fromString(v1785);
                File_system::US5::US5_0(sprintf!(
                    "{}-{}-{}",
                    getSlice(v1787.clone(), Some(0_i32), Some(17_i32)),
                    getSlice(v1787.clone(), Some(18_i32), Some(21_i32)),
                    getCharAt(v1787, 22_i32)
                ))
            }
            _ => File_system::US5::US5_1,
        };
        let v1796: string = match &v1792 {
            File_system::US5::US5_0(v1792_0_0) => match &v1792 {
        ...
        let v1805: LrcPtr<TimeZoneInfo> = fable_library_rust::Native_::getZero();
        let v1899: i64 = v1645.ticks();
        let v1933: string = string(
        ...
        let v2034: TimeSpan = TimeSpan::new_ticks(chrono::FixedOffset::local_minus_utc(
            &chrono::DateTime::timezone(&chrono::DateTime::fixed_offset(
                &chrono::DateTime::from_timestamp_nanos(v1899),
            )),
        ) as i64);
        let v2055: u8 = if (v2034.hours()) > 0_i32 { 1_u8 } else { 0_u8 };
        let v2056: string = File_system::method85();
        let v2276: string = v2034.toString(v2056);
        let v2417: string = sprintf!(
            "{}{}{}",
            v2055,
            getSlice(v2276.clone(), Some(0_i32), Some(1_i32)),
            getSlice(v2276, Some(3_i32), Some(4_i32))
        );
        let v2420: string = toString(v0);
        parse(concat(new_array(&[
            v1796.clone(),
            v2417.clone(),
            getSlice(
                v2420.clone(),
                Some((length(v1796)) + (length(v2417))),
                Some((length(v2420)) - 1_i32),
            ),
        ])))
    }
    ...
    pub fn method82() -> string {
        let v67: DateTime = DateTime::now();
        File_system::method88(File_system::method83(new_guid(), v67))
    }
    ...
    pub fn method117(
        ...
        if (v2) >= 11_u8 {
            ...
            let v48_1: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v39_1);
            Err(v48_1)
        } else {
            if let File_system::US5::US5_0(v31_1_0_0) = &v31_1 {
                if (v4.clone()) != string("") {
                    ...
                    match &v120 {
                        File_system::US15::US15_0(v120_0_0) => {
                            ...
                            let v173: &str = &*v164;
                            let v209: std::string::String = String::from(v173);
                            let v245: std::path::PathBuf = std::path::PathBuf::from(v209);
                            Ok(v245)
                        }
                ...
                let v411: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v402);
                Err(v411)
            }
        }
    }
    pub fn method116(v0: string, v1: u8, v2: string) -> Result<std::path::PathBuf, std::io::Error> {
        let v54: Result<std::path::PathBuf, std::io::Error> = std::fs::read_link(&*v2.clone());
        let v55 = File_system::method45();
        let v68: Result<std::path::PathBuf, string> = v54.map_err(|x| v55(x));
        let v71 = File_system::method114();
        let v72 = File_system::method115();
        let v74: File_system::US15 = match &v68 {
            Err(v68_1_0) => v72(v68_1_0.clone()),
            Ok(v68_0_0) => v71(v68_0_0.clone()),
        };
        match &v74 {
            File_system::US15::US15_0(v74_0_0) => Ok(v74_0_0.clone()),
            File_system::US15::US15_1(v74_1_0) => File_system::method117(
                v0.clone(),
                Func2::new({
                    let v0 = v0.clone();
    ...
    pub fn method120(
        ...
        if (v2) >= 11_u8 {
            ...
            let v47_1: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v38_1);
            Err(v47_1)
        } else {
            if let File_system::US5::US5_0(v30_0_0) = &v30 {
                if (v0.clone()) != string("") {
                    ...
                    match &v119 {
                        File_system::US15::US15_0(v119_0_0) => {
                            ...
                            let v172: &str = &*v163;
                            let v208: std::string::String = String::from(v172);
                            let v244: std::path::PathBuf = std::path::PathBuf::from(v208);
                            Ok(v244)
                        }
                ...
                let v410: std::io::Error = std::io::Error::new(std::io::ErrorKind::Other, &*v401);
                Err(v410)
            }
        }
    }
    pub fn method113(v0: string, v1: u8) -> Result<std::path::PathBuf, std::io::Error> {
        let v53_1: Result<std::path::PathBuf, std::io::Error> = std::fs::read_link(&*v0.clone());
        let v54 = File_system::method45();
        let v67: Result<std::path::PathBuf, string> = v53_1.map_err(|x| v54(x));
        let v70 = File_system::method114();
        let v71 = File_system::method115();
        let v73: File_system::US15 = match &v67 {
            Err(v67_1_0) => v71(v67_1_0.clone()),
            Ok(v67_0_0) => v70(v67_0_0.clone()),
        };
        match &v73 {
            File_system::US15::US15_0(v73_0_0) => Ok(v73_0_0.clone()),
            File_system::US15::US15_1(v73_1_0) => File_system::method120(
                v0.clone(),
                Func2::new({
                    let v0 = v0.clone();
                    move |b0: u8, b1: string| {
    ...
    pub fn method121(v0: string, v1: u8) -> Result<std::path::PathBuf, std::io::Error> {
        ...
        if v46_1 {
            let v57: bool = unbox::<bool>(fable_library_rust::Native_::getZero());
    ...
    pub fn method111(v0: string) -> string {
        if (v0.clone()) == string("") {
            ...
            let v43_1: File_system::US16 =
                defaultValue(File_system::US16::US16_1, map(File_system::method128(), v9));
