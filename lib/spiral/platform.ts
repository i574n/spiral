...
import { union_type, TypeInfo } from "../../deps/polyglot/deps/Fable/src/fable-library-ts/Reflection.js";
...
export function US1_$reflection(): TypeInfo {
    return union_type("Platform.US1", [], US1, () => [[["f0_0", US0_$reflection()]], [["f1_0", US0_$reflection()]], [["f2_0", US0_$reflection()]], [["f3_0", US0_$reflection()]], [["f4_0", US0_$reflection()]], [["f5_0", US0_$reflection()]], [["f6_0", US0_$reflection()]]]);
}

export function closure0(unitVar: void, unitVar_1: void): boolean {
    throw new Error(`platform.is_windows / target: ${US1_US1_5(US0_US0_0())}`);
}
