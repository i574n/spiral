...
def method7(v0_1: US0) -> bool:
    ...
    if pattern_input[2].l0 == False:
        ...
        return find(v0_1, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr221())) >= find(v42, of_seq(to_enumerable([(US0(0), 0), (US0(1), 1), (US0(2), 2), (US0(3), 3), (US0(4), 4)]), ObjectExpr222()))
    ...
    def _arrow243(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3: Any=v3, v4: Any=v4, v5: Any=v5, v6: Any=v6, v7: Any=v7, v8: Any=v8, v9: Any=v9, v10: Any=v10) -> Async[None]:
        ...
        def _arrow241(__unit: None=None) -> Async[None]:
            ...
            def _arrow235(__unit: None=None) -> Async[None]:
                ...
                return singleton.Bind(v850, _arrow234)
            ...
            return singleton.Combine(_arrow235() if (v844.tag == 0) else _expr236(), singleton.Delay(_arrow240))

        def _arrow242(__unit: None=None) -> Async[None]:
            return singleton.Zero()

        return singleton.Combine(_arrow241() if v827 else singleton.Zero(), singleton.Delay(_arrow242))
        ...
        if v173.tag == 0:
            ...
            if v339.tag == 0:
                ...
                if v346.tag == 0:
                    ...
                    def _arrow265(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3: Any=v3, v4: Any=v4) -> IEnumerable_1[str]:
                        return v353

                    v377 = US8(0, join("", delay(_arrow265)), v346.fields[1], v346.fields[2], v346.fields[3], v346.fields[4])
            ...
            if v566.tag == 0:
                ...
                if v600.tag == 0:
                    ...
                    def _arrow267(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3: Any=v3, v4: Any=v4) -> IEnumerable_1[str]:
                        return v607

                    v635 = US8(0, join("", delay(_arrow267)), v600.fields[1], v600.fields[2], v600.fields[3], v600.fields[4])
...
def method60(v0_1: str) -> US16:
    ...
    v21_1: US17 = method61(UH2(0), default_arg(_arrow271() if (_v0 is None) else value_12(_v0), ""), StringBuilder__ctor_Z721C83C5(method26()), 1, 1)
    if v21_1.tag == 0:
...
def _arrow274(__unit: None=None) -> None:
    closure3(None, None)


v17: Callable[[], None] = _arrow274

def current_process_kill(__unit: None=None) -> None:
    v17(None)


def _arrow275(v: str) -> Async[tuple[int, str]]:
    return closure13(None, v)


v18: Callable[[str], Async[tuple[int, str]]] = _arrow275

def execute_async(x: str) -> Async[tuple[int, str]]:
    return v18(x)


def _arrow276(_arg10: tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]) -> Async[tuple[int, str]]:
    return closure27(None, _arg10)


v19: Callable[[tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]], Async[tuple[int, str]]] = _arrow276
...
def _arrow277(v: Callable[[Heap0], Heap0]) -> tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]:
    return closure28(None, v)


v20: Callable[[Callable[[Heap0], Heap0]], tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]] = _arrow277
...
v21: Callable[[str], FSharpResult_2[Array[str], str]] = _arrow278
