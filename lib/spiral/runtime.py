...
def method25(v0_1: str) -> US6:
    ...
    v10: str = default_arg(_arrow231() if (_v0 is None) else value_12(_v0), "")
    ...
    def _arrow242(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3: Any=v3, v4: Any=v4, v5: Any=v5, v6: Any=v6, v7: Any=v7, v8: Any=v8, v9: Any=v9, v10: Any=v10) -> Async[None]:
        ...
        def _arrow240(__unit: None=None) -> Async[None]:
            ...
            def _arrow234(__unit: None=None) -> Async[None]:
                ...
                return singleton.Bind(v868, _arrow233)
            ...
            return singleton.Combine(_arrow234() if (v862.tag == 0) else _expr235(), singleton.Delay(_arrow239))

        def _arrow241(__unit: None=None) -> Async[None]:
            return singleton.Zero()

        return singleton.Combine(_arrow240() if v843 else singleton.Zero(), singleton.Delay(_arrow241))
        ...
        if v181.tag == 0:
            ...
            if v355.tag == 0:
                ...
                if v362.tag == 0:
                    ...
                    v393 = US8(0, join("", delay(_arrow252)), v362.fields[1], v362.fields[2], v362.fields[3], v362.fields[4])
            ...
            if v590.tag == 0:
                ...
                if v624.tag == 0:
                    ...
                    v659 = US8(0, join("", delay(_arrow253)), v624.fields[1], v624.fields[2], v624.fields[3], v624.fields[4])
...
def method60(v0_1: str) -> US16:
    ...
    v22: US17 = method61(UH2(0), default_arg(_arrow254() if (_v0 is None) else value_12(_v0), ""), StringBuilder__ctor_Z721C83C5(method26()), 1, 1)
    if v22.tag == 0:
...
v18: Callable[[str], Async[tuple[int, str]]] = _arrow258
...
v19: Callable[[tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]], Async[tuple[int, str]]] = _arrow259
...
v20: Callable[[Callable[[Heap0], Heap0]], tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]] = _arrow260
...
v21: Callable[[str], FSharpResult_2[Array[str], str]] = _arrow261
