        ...
        if v140.tag == 0:
            ...
            if v268.tag == 0:
                ...
                if v275.tag == 0:
                    ...
                    v302 = US8(0, join("", delay(_arrow265)), v275.fields[1], v275.fields[2], v275.fields[3], v275.fields[4])
            ...
            if v452.tag == 0:
                ...
                if v486.tag == 0:
                    ...
                    v517 = US8(0, join("", delay(_arrow267)), v486.fields[1], v486.fields[2], v486.fields[3], v486.fields[4])
...
v17: Callable[[str], Async[tuple[int, str]]] = _arrow275
...
v18: Callable[[tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]], Async[tuple[int, str]]] = _arrow276
...
v19: Callable[[Callable[[Heap0], Heap0]], tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]] = _arrow277
