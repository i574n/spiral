...
def method25(v0_1: str) -> US6:
    ...
    v9: str = default_arg(_arrow231() if (_v0 is None) else value_12(_v0), "")
    ...
    def _arrow242(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1, v3: Any=v3, v4: Any=v4, v5: Any=v5, v6: Any=v6, v7: Any=v7, v8: Any=v8, v9: Any=v9, v10: Any=v10) -> Async[None]:
        ...
        def _arrow240(__unit: None=None) -> Async[None]:
            ...
            def _arrow234(__unit: None=None) -> Async[None]:
                ...
                return singleton.Bind(v850, _arrow233)
            ...
            return singleton.Combine(_arrow234() if (v844.tag == 0) else _expr235(), singleton.Delay(_arrow239))

        def _arrow241(__unit: None=None) -> Async[None]:
            return singleton.Zero()

        return singleton.Combine(_arrow240() if v827 else singleton.Zero(), singleton.Delay(_arrow241))
...
def method54(v0_1: bool, v1_1: Any, v2_1: CancellationToken) -> Async[int]:
    def _arrow248(__unit: None=None, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> Async[int]:
        def _arrow246(__unit: None=None) -> Async[int]:
            ...
            return singleton.Bind(v3205, _arrow245)
        ...
        if v173.tag == 0:
            ...
            if v339.tag == 0:
                ...
                if v346.tag == 0:
                    ...
                    v377 = US8(0, join("", delay(_arrow253)), v346.fields[1], v346.fields[2], v346.fields[3], v346.fields[4])
            ...
            if v566.tag == 0:
                ...
                if v600.tag == 0:
                    ...
                    v635 = US8(0, join("", delay(_arrow254)), v600.fields[1], v600.fields[2], v600.fields[3], v600.fields[4])
...
def method60(v0_1: str) -> US16:
    ...
    v21_1: US17 = method61(UH2(0), default_arg(_arrow255() if (_v0 is None) else value_12(_v0), ""), StringBuilder__ctor_Z721C83C5(method26()), 1, 1)
    if v21_1.tag == 0:
...
v18: Callable[[str], Async[tuple[int, str]]] = _arrow259
...
v19: Callable[[tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]], Async[tuple[int, str]]] = _arrow260
...
v20: Callable[[Callable[[Heap0], Heap0]], tuple[str, CancellationToken | None, Array[tuple[str, str]], Callable[[tuple[int, str, bool]], Async[None]] | None, Callable[[std_sync_arc_1[std_sync_mutex_1[std_process_child_stdin]]], None] | None, bool, str | None]] = _arrow261
...
v21: Callable[[str], FSharpResult_2[Array[str], str]] = _arrow262
