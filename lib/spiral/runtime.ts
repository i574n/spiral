...
export function closure14(unitVar: void, _arg: [string, any, int32, int32]): US8_$union {
    ...
    if ("" === v0) {
        return US8_US8_1(toText(interpolate("parsing.p_char / unexpected end of input / c: \'%P()\' / s: %A%P()", ["\"", [v1, v2, v3] as [any, int32, int32]])));
    }
    else {
        ...
        if (v10 === "\"") {
            ...
            return US8_US8_0(v10, v45, patternInput[0], patternInput[1], patternInput[2]);
        }
        else {
            const v66: int32 = (v0.indexOf("\n") - 1) | 0;
            const v81 = 0;
            const v102: int32 = (((-2 === v66) ? (v0.length + 1) : (v66 + 1)) - 1) | 0;
            return US8_US8_1(concat(`parsing.p_char / expected: '${"\""}' / line: ${v2} / col: ${v3}
...
export function method28(v0_mut: string, v1_mut: any, v2_mut: UH1_$union): US8_$union {
    method28:
    while (true) {
...
export function method30(v0_mut: string, v1_mut: string, v2_mut: any, v3_mut: int32, v4_mut: int32): [string, string, any, int32, int32] {
    ...
    while (true) {
        ...
        let v98: US8_$union;
        if ("" === v1) {
            v98 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected end of input / chars: %A%P() / s: %A%P()", [["\"", "\'"], [v2, v3, v4] as [any, int32, int32]])));
        }
        else {
            ...
            if (method29(v25, 0n) === false) {
                ...
                v98 = US8_US8_0(v25, v62, patternInput[0], patternInput[1], patternInput[2]);
            }
            else {
                v98 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected char: \'%P()\' / chars: %A%P() / s: %A%P()", [v25, ["\"", "\'"], [v2, v3, v4] as [any, int32, int32]])));
            }
        }
        let v110: US8_$union;
        if ((v98.tag as int32) === /* US8_0 */ 0) {
            const v99 = v98.fields[0] as any;
            v110 = US8_US8_0(("\\" === v99) ? "/" : v99, v98.fields[1] as any, v98.fields[2] as any, v98.fields[3] as any, v98.fields[4] as any);
        }
        else {
            v110 = US8_US8_1(v98.fields[0] as any);
        }
        if ((v110.tag as int32) === /* US8_0 */ 0) {
...
export function method31(v0_mut: string, v1_mut: any, v2_mut: int32, v3_mut: int32, v4_mut: UH1_$union): US8_$union {
    method31:
    while (true) {
...
export function method33(v0_mut: string, v1_mut: string, v2_mut: any, v3_mut: int32, v4_mut: int32): [string, string, any, int32, int32] {
    ...
    while (true) {
        ...
        let v106: US8_$union;
        if ("" === v1) {
            v106 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected end of input / chars: %A%P() / s: %A%P()", [["\"", "\'", " "], [v2, v3, v4] as [any, int32, int32]])));
        }
        else {
            ...
            if (method32(v29, 0n) === false) {
                ...
                v106 = US8_US8_0(v29, v66, patternInput[0], patternInput[1], patternInput[2]);
            }
            else {
                v106 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected char: \'%P()\' / chars: %A%P() / s: %A%P()", [v29, ["\"", "\'", " "], [v2, v3, v4] as [any, int32, int32]])));
            }
        }
        let v118: US8_$union;
        if ((v106.tag as int32) === /* US8_0 */ 0) {
            const v107 = v106.fields[0] as any;
            v118 = US8_US8_0(("\\" === v107) ? "/" : v107, v106.fields[1] as any, v106.fields[2] as any, v106.fields[3] as any, v106.fields[4] as any);
        }
        else {
            v118 = US8_US8_1(v106.fields[0] as any);
        }
        if ((v118.tag as int32) === /* US8_0 */ 0) {
...
export function method35(v0_mut: string, v1_mut: string, v2_mut: any, v3_mut: int32, v4_mut: int32): [string, string, any, int32, int32] {
    ...
    while (true) {
        ...
        let v66: US8_$union;
        if ("" === v1) {
            v66 = US8_US8_1(toText(interpolate("parsing.any_char / unexpected end of input / s: %A%P()", [[v2, v3, v4] as [any, int32, int32]])));
        }
        else {
            ...
            v66 = US8_US8_0(v16_1, v50, patternInput[0], patternInput[1], patternInput[2]);
        }
...
export function method23(v0: string): US7_$union {
    ...
    const v24: US8_$union = method28(v10, v16_1, UH1_UH1_1(v19, UH1_UH1_1(v20, UH1_UH1_0())));
    let v197: US9_$union;
    if ((v24.tag as int32) === /* US8_0 */ 0) {
        ...
        let v123: US8_$union;
        if ("" === v26) {
            v123 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected end of input / chars: %A%P() / s: %A%P()", [["\"", "\'"], [v27, v28, v29] as [any, int32, int32]])));
        }
        else {
            ...
            if (method29(v50, 0n) === false) {
                ...
                v123 = US8_US8_0(v50, v87, patternInput[0], patternInput[1], patternInput[2]);
            }
            else {
                v123 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected char: \'%P()\' / chars: %A%P() / s: %A%P()", [v50, ["\"", "\'"], [v27, v28, v29] as [any, int32, int32]])));
            }
        }
        let v135: US8_$union;
        if ((v123.tag as int32) === /* US8_0 */ 0) {
            const v124 = v123.fields[0] as any;
            v135 = US8_US8_0(("\\" === v124) ? "/" : v124, v123.fields[1] as any, v123.fields[2] as any, v123.fields[3] as any, v123.fields[4] as any);
        }
        else {
            v135 = US8_US8_1(v123.fields[0] as any);
        }
        let v155: US9_$union;
        if ((v135.tag as int32) === /* US8_0 */ 0) {
            ...
            v155 = US9_US9_0(patternInput_1[0], patternInput_1[1], patternInput_1[2], patternInput_1[3], patternInput_1[4]);
        }
        else {
            v155 = US9_US9_1(v135.fields[0] as any);
        }
        let v165: US9_$union;
        if ((v155.tag as int32) === /* US9_0 */ 0) {
            v165 = US9_US9_0(v155.fields[0] as any, v155.fields[1] as any, v155.fields[2] as any, v155.fields[3] as any, v155.fields[4] as any);
        }
        else {
            const v162 = v155.fields[0] as any;
            v165 = US9_US9_0("", v26, v27, v28, v29);
        }
        if ((v165.tag as int32) === /* US9_0 */ 0) {
            ...
            const v174: US8_$union = method31(v167, v168, v169, v170, UH1_UH1_1(v19, UH1_UH1_1(v20, UH1_UH1_0())));
            if ((v174.tag as int32) === /* US8_0 */ 0) {
                const v175 = v174.fields[0] as any;
                v197 = US9_US9_0(v166, v174.fields[1] as any, v174.fields[2] as any, v174.fields[3] as any, v174.fields[4] as any);
            }
            else {
                v197 = US9_US9_1(toText(interpolate("parsing.between / expected closing delimiter / e: %A%P() / input: %A%P() / rest1: %A%P() / rest2: %A%P()", [v174.fields[0] as any, [v10, v16_1, 1, 1] as [string, any, int32, int32], [v26, v27, v28, v29] as [string, any, int32, int32], [v167, v168, v169, v170] as [string, any, int32, int32]])));
            }
        }
        else {
            const v189 = v165.fields[0] as any;
            v197 = US9_US9_1("parsing.between / expected content");
        }
    }
    else {
        v197 = US9_US9_1(v24.fields[0] as any);
    }
    let v416: US9_$union;
    if ((v197.tag as int32) === /* US9_0 */ 0) {
        ...
        let v307: US8_$union;
        if ("" === v10) {
            v307 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected end of input / chars: %A%P() / s: %A%P()", [["\"", "\'", " "], [v16_1, 1, 1] as [any, int32, int32]])));
        }
        else {
            ...
            if (method32(v228, 0n) === false) {
                ...
                v307 = US8_US8_0(v228, v265, patternInput_2[0], patternInput_2[1], patternInput_2[2]);
            }
            else {
                v307 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected char: \'%P()\' / chars: %A%P() / s: %A%P()", [v228, ["\"", "\'", " "], [v16_1, 1, 1] as [any, int32, int32]])));
            }
        }
        let v319: US8_$union;
        if ((v307.tag as int32) === /* US8_0 */ 0) {
            const v308 = v307.fields[0] as any;
            v319 = US8_US8_0(("\\" === v308) ? "/" : v308, v307.fields[1] as any, v307.fields[2] as any, v307.fields[3] as any, v307.fields[4] as any);
        }
        else {
            v319 = US8_US8_1(v307.fields[0] as any);
        }
        let v339: US9_$union;
        if ((v319.tag as int32) === /* US8_0 */ 0) {
            ...
            v339 = US9_US9_0(patternInput_3[0], patternInput_3[1], patternInput_3[2], patternInput_3[3], patternInput_3[4]);
        }
        else {
            v339 = US9_US9_1(v319.fields[0] as any);
        }
        if ((v339.tag as int32) === /* US9_0 */ 0) {
            ...
            const v354: US11_$union = (v10.length === 0) ? US11_US11_0(v10, v16_1, 1, 1) : US11_US11_1(toText(interpolate("parsing.eof / expected end of input / input: %A%P()", [v10])));
            const v363: US9_$union = ((v354.tag as int32) === /* US11_0 */ 0) ? US9_US9_0("", v354.fields[0] as any, v354.fields[1] as any, v354.fields[2] as any, v354.fields[3] as any) : US9_US9_1(v354.fields[0] as any);
            if ((v363.tag as int32) === /* US9_0 */ 0) {
                ...
                v416 = US9_US9_0(v364, v365.slice(v381, v402 + 1), v366, v367, v368);
            }
            else {
                v416 = US9_US9_1(v363.fields[0] as any);
            }
        }
    }
    let v671: US12_$union;
    if ((v416.tag as int32) === /* US9_0 */ 0) {
        ...
        let v542: US8_$union;
        if ("" === v418) {
            v542 = US8_US8_1(toText(interpolate("parsing.p_char / unexpected end of input / c: \'%P()\' / s: %A%P()", [" ", [v419, v420, v421] as [any, int32, int32]])));
        }
        else {
            ...
            if (v428 === " ") {
                ...
                v542 = US8_US8_0(v428, v463, patternInput_4[0], patternInput_4[1], patternInput_4[2]);
            }
            else {
                const v484: int32 = (v418.indexOf("\n") - 1) | 0;
                const v499 = 0;
                const v520: int32 = (((-2 === v484) ? (v418.length + 1) : (v484 + 1)) - 1) | 0;
                v542 = US8_US8_1(concat(`parsing.p_char / expected: '${" "}' / line: ${v420} / col: ${v421}
${v419}${v418.slice(v499, v520 + 1)}`, "\n", method27(v421 - 1, 0)("") + "^", ..."\n"));
            }
        }
        let v554: US13_$union;
        if ((v542.tag as int32) === /* US8_0 */ 0) {
            v554 = US13_US13_0(US10_US10_0(v542.fields[0] as any), v542.fields[1] as any, v542.fields[2] as any, v542.fields[3] as any, v542.fields[4] as any);
        }
        else {
            const v550 = v542.fields[0] as any;
            v554 = US13_US13_0(US10_US10_1(), v418, v419, v420, v421);
        }
        let v645: US9_$union;
        if ((v554.tag as int32) === /* US13_0 */ 0) {
            ...
            let v621: US8_$union;
            if ("" === v556) {
                v621 = US8_US8_1(toText(interpolate("parsing.any_char / unexpected end of input / s: %A%P()", [[v557, v558, v559] as [any, int32, int32]])));
            }
            else {
                ...
                v621 = US8_US8_0(v571, v605, patternInput_5[0], patternInput_5[1], patternInput_5[2]);
            }
            if ((v621.tag as int32) === /* US8_0 */ 0) {
                ...
                v645 = US9_US9_0(patternInput_6[0], patternInput_6[1], patternInput_6[2], patternInput_6[3], patternInput_6[4]);
            }
            else {
                v645 = US9_US9_1(v621.fields[0] as any);
            }
        }
        else {
            v645 = US9_US9_1(v554.fields[0] as any);
        }
        let v657: US14_$union;
        if ((v645.tag as int32) === /* US9_0 */ 0) {
            v657 = US14_US14_0(US5_US5_0(v645.fields[0] as any), v645.fields[1] as any, v645.fields[2] as any, v645.fields[3] as any, v645.fields[4] as any);
        }
        else {
            const v653 = v645.fields[0] as any;
            v657 = US14_US14_0(US5_US5_1(), v418, v419, v420, v421);
        }
        v671 = (((v657.tag as int32) === /* US14_0 */ 0) ? US12_US12_0(v417, v657.fields[0] as any, v657.fields[1] as any, v657.fields[2] as any, v657.fields[3] as any, v657.fields[4] as any) : US12_US12_1(v657.fields[0] as any));
    }
    else {
        v671 = US12_US12_1(v416.fields[0] as any);
    }
    if ((v671.tag as int32) === /* US12_0 */ 0) {
        ...
        return US7_US7_0(v671.fields[0] as any, v671.fields[1] as any);
    }
    else {
        return US7_US7_1(v671.fields[0] as any);
    }
}
...
export function method38(v0: string, v1: US5_$union, v2: string, v3: Option<any>, v4: [string, string][], v5: Option<((arg0: [int32, string, boolean]) => Async<void>)>, v6: Option<((arg0: any) => void)>, v7: boolean, v8: Option<string>): string {
...
export function method37(v0: Mut0, v1: Mut1, v2: Mut2, v3: Mut3, v4: Mut4, v5: Option<int64>, v6: string, v7: string, v8: string, v9: US5_$union, v10: string, v11: Option<any>, v12: [string, string][], v13: Option<((arg0: [int32, string, boolean]) => Async<void>)>, v14_1: Option<((arg0: any) => void)>, v15_1: boolean, v16_1: Option<string>): string {
    const v17: string = method38(v8, v9, v10, v11, v12, v13, v14_1, v15_1, v16_1);
...
export function closure17(v0: string, v1: Option<any>, v2: [string, string][], v3: Option<((arg0: [int32, string, boolean]) => Async<void>)>, v4: Option<((arg0: any) => void)>, v5: boolean, v6: Option<string>, v7: US5_$union, v8: string, unitVar: void): void {
    ...
    if (((patternInput[2].l0 === false) ? false : (1 >= find<US0_$union, int32>(v66, ofSeq([[US0_US0_0(), 0] as [US0_$union, int32], [US0_US0_1(), 1] as [US0_$union, int32], [US0_US0_2(), 2] as [US0_$union, int32], [US0_US0_3(), 3] as [US0_$union, int32], [US0_US0_4(), 4] as [US0_$union, int32]], {
        ...
        const v132: string = method37(v112, v113, v114, v115, v116, v117, method7(v112, v113, v114, v115, v116, v117), method36(), v8, v7, v0, v1, v2, v3, v4, v5, v6);
        let v148: any;
        v24();
        v148 = undefined;
        const patternInput_2: [Mut0, Mut1, Mut2, Mut3, Mut4, Option<int64>] = value_12(TraceState_trace_state());
...
export function method39(v0: string, v1: Option<any>, v2: [string, string][], v3: Option<((arg0: [int32, string, boolean]) => Async<void>)>, v4: Option<((arg0: any) => void)>, v5: boolean, v6: Option<string>): [string, string][] {
    return v2;
}

export function method40(v0: int32, v1: Mut5): boolean {
    return v1.l0 < v0;
}

export function method43(v0: boolean): string {
    return defaultOf();
}
...
export function method44(): ((arg0: ((arg0: [int32, string, boolean]) => Async<void>)) => US15_$union) {
    return (v: ((arg0: [int32, string, boolean]) => Async<void>)): US15_$union => closure19(undefined, v);
}

export function method45(v0: boolean): int32 {
    return defaultOf();
}
...
export function method47(v0: Mut0, v1: Mut1, v2: Mut2, v3: Mut3, v4: Mut4, v5: Option<int64>, v6: string, v7: string, v8: string): string {
...
export function closure20(v0: string, unitVar: void): void {
    ...
    if (((patternInput[2].l0 === false) ? false : (0 >= find<US0_$union, int32>(v58, ofSeq([[US0_US0_0(), 0] as [US0_$union, int32], [US0_US0_1(), 1] as [US0_$union, int32], [US0_US0_2(), 2] as [US0_$union, int32], [US0_US0_3(), 3] as [US0_$union, int32], [US0_US0_4(), 4] as [US0_$union, int32]], {
        ...
        const v127: string = (v0 === "") ? "" : method47(v104, v105, v106, v107, v108, v109, method7(v104, v105, v106, v107, v108, v109), method46(), v0);
        let v143: any;
        v16_1();
        v143 = undefined;
        const patternInput_2: [Mut0, Mut1, Mut2, Mut3, Mut4, Option<int64>] = value_12(TraceState_trace_state());
...
export function method42(v0: string, v1: Option<any>, v2: [string, string][], v3: Option<((arg0: [int32, string, boolean]) => Async<void>)>, v4: Option<((arg0: any) => void)>, v5: boolean, v6: Option<string>, v7: boolean, v8: any, v9: boolean, v10: boolean): Async<void> {
    return singleton.Delay<void>((): Async<void> => {
        let v8990: US15_$union, v8996: Async<void>;
        const v8959: string = method43(v10);
        const v8965: boolean = (v8959 === defaultOf()) !== true;
        return singleton.Combine<void>(v8965 ? ((v8990 = defaultArg(map<((arg0: [int32, string, boolean]) => Async<void>), US15_$union>(method44(), v3), US15_US15_1()), singleton.Combine<void>(((v8990.tag as int32) === /* US15_0 */ 0) ? ((v8996 = (v8990.fields[0] as any)([method45(v7), v8959, v9] as [int32, string, boolean]), singleton.Bind<void, void>(v8996, (): Async<void> => {
...
export function closure18(v0: string, v1: Option<any>, v2: [string, string][], v3: Option<((arg0: [int32, string, boolean]) => Async<void>)>, v4: Option<((arg0: any) => void)>, v5: boolean, v6: Option<string>, v7: boolean, v8: any, v9: boolean, v10: boolean): void {
    startImmediate(method41(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10));
}
...
export function method48(): ((arg0: any) => US16_$union) {
    return (v: any): US16_$union => closure21(undefined, v);
}

export function method49(v0: any): Async<any> {
...
export function method50(v0: boolean): boolean {
    return defaultOf();
}

export function method51(v0: boolean): void {
}
...
export function method54(v0: any): string {
    const v2: Mut3 = new Mut3(method13());
    let v16_1: any;
...
export function method53(v0: Mut0, v1: Mut1, v2: Mut2, v3: Mut3, v4: Mut4, v5: Option<int64>, v6: string, v7: string, v8: any): string {
...
export function closure23(v0: any, unitVar: void): void {
    ...
    if (((patternInput[2].l0 === false) ? false : (3 >= find<US0_$union, int32>(v58, ofSeq([[US0_US0_0(), 0] as [US0_$union, int32], [US0_US0_1(), 1] as [US0_$union, int32], [US0_US0_2(), 2] as [US0_$union, int32], [US0_US0_3(), 3] as [US0_$union, int32], [US0_US0_4(), 4] as [US0_$union, int32]], {
        ...
        const v105: Mut1 = patternInput_1[1];
        const v104: Mut0 = patternInput_1[0];
        const v124: string = method53(v104, v105, v106, v107, v108, v109, method7(v104, v105, v106, v107, v108, v109), method11(), v0);
        let v140: any;
        v16_1();
        v140 = undefined;
        const patternInput_2: [Mut0, Mut1, Mut2, Mut3, Mut4, Option<int64>] = value_12(TraceState_trace_state());
...
export function method52(v0: boolean, v1: any, v2: any): Async<int32> {
...
export function method57(v0: int32, v1: int32, v2: string, v3: Option<any>, v4: [string, string][], v5: Option<((arg0: [int32, string, boolean]) => Async<void>)>, v6: Option<((arg0: any) => void)>, v7: boolean, v8: Option<string>): string {
    const v10: Mut3 = new Mut3(method13());
    let v24: any;
    closure7(v10, "{ ", undefined);
    v24 = undefined;
...
export function method56(v0: Mut0, v1: Mut1, v2: Mut2, v3: Mut3, v4: Mut4, v5: Option<int64>, v6: string, v7: string, v8: int32, v9: int32, v10: string, v11: Option<any>, v12: [string, string][], v13: Option<((arg0: [int32, string, boolean]) => Async<void>)>, v14_1: Option<((arg0: any) => void)>, v15_1: boolean, v16_1: Option<string>): string {
    const v17: string = method57(v8, v9, v10, v11, v12, v13, v14_1, v15_1, v16_1);
    return method17((((((((v6 + " ") + v7) + " #") + int64ToString(v0.l0)) + " ") + "runtime.execute_with_options_async") + " / ") + v17);
}
...
export function closure24(v0: string, v1: Option<any>, v2: [string, string][], v3: Option<((arg0: [int32, string, boolean]) => Async<void>)>, v4: Option<((arg0: any) => void)>, v5: boolean, v6: Option<string>, v7: int32, v8: string, unitVar: void): void {
    ...
    if (((patternInput[2].l0 === false) ? false : (1 >= find<US0_$union, int32>(v66, ofSeq([[US0_US0_0(), 0] as [US0_$union, int32], [US0_US0_1(), 1] as [US0_$union, int32], [US0_US0_2(), 2] as [US0_$union, int32], [US0_US0_3(), 3] as [US0_$union, int32], [US0_US0_4(), 4] as [US0_$union, int32]], {
        ...
        const v113: Mut1 = patternInput_1[1];
        const v112: Mut0 = patternInput_1[0];
        const v133: string = method56(v112, v113, v114, v115, v116, v117, method7(v112, v113, v114, v115, v116, v117), method36(), v7, v8.length, v0, v1, v2, v3, v4, v5, v6);
        let v149: any;
        v24();
        v149 = undefined;
        const patternInput_2: [Mut0, Mut1, Mut2, Mut3, Mut4, Option<int64>] = value_12(TraceState_trace_state());
...
export function method61(v0_mut: string, v1_mut: string, v2_mut: any, v3_mut: int32, v4_mut: int32): [string, string, any, int32, int32] {
    method61:
    while (true) {
        const v0: string = v0_mut, v1: string = v1_mut, v2: any = v2_mut, v3: int32 = v3_mut, v4: int32 = v4_mut;
        let v114: US8_$union;
        if ("" === v1) {
            v114 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected end of input / chars: %A%P() / s: %A%P()", [["\\", "`", "\"", " "], [v2, v3, v4] as [any, int32, int32]])));
        }
        else {
            const v33_1: string = v1[0];
            if (method60(v33_1, 0n) === false) {
                const v47 = 1;
                ...
                v114 = US8_US8_0(v33_1, v70, patternInput[0], patternInput[1], patternInput[2]);
            }
            else {
                v114 = US8_US8_1(toText(interpolate("parsing.none_of / unexpected char: \'%P()\' / chars: %A%P() / s: %A%P()", [v33_1, ["\\", "`", "\"", " "], [v2, v3, v4] as [any, int32, int32]])));
            }
        }
        if ((v114.tag as int32) === /* US8_0 */ 0) {
...
export function method63(v0_mut: string, v1_mut: int64): boolean {
    method63:
    while (true) {
        const v0: string = v0_mut, v1: int64 = v1_mut;
        if (compare_1(v1, 3n) >= 0) {
...
export function closure28(unitVar: void, _arg: [string, any, int32, int32]): US9_$union {
    ...
    let v125: US8_$union;
    if ("" === v0) {
        v125 = US8_US8_1(toText(interpolate("parsing.p_char / unexpected end of input / c: \'%P()\' / s: %A%P()", ["\\", [v1, v2, v3] as [any, int32, int32]])));
    }
    else {
        const v10: string = v0[0];
        if (v10 === "\\") {
            ...
            const v51: string = v10;
            const patternInput: [any, int32, int32] = method26(method25(toInt64(fromInt32(v51.length)), v51, 0n), v1, v2, v3);
            v125 = US8_US8_0(v10, v45, patternInput[0], patternInput[1], patternInput[2]);
        }
        else {
            const v66: int32 = (v0.indexOf("\n") - 1) | 0;
            const v81 = 0;
            const v102: int32 = (((-2 === v66) ? (v0.length + 1) : (v66 + 1)) - 1) | 0;
            v125 = US8_US8_1(concat(`parsing.p_char / expected: '${"\\"}' / line: ${v2} / col: ${v3}
${v1}${v0.slice(v81, v102 + 1)}`, "\n", method27(v3 - 1, 0)("") + "^", ..."\n"));
        }
    }
    let v196: US8_$union;
    if ((v125.tag as int32) === /* US8_0 */ 0) {
        ...
        if ("" === v127) {
            v196 = US8_US8_1(toText(interpolate("parsing.any_char / unexpected end of input / s: %A%P()", [[v128, v129, v130] as [any, int32, int32]])));
        }
        else {
            ...
            v196 = US8_US8_0(v142, v176, patternInput_1[0], patternInput_1[1], patternInput_1[2]);
        }
    }
    else {
        v196 = US8_US8_1(v125.fields[0] as any);
    }
    if ((v196.tag as int32) === /* US8_0 */ 0) {
        return US9_US9_0("\\" + (v196.fields[0] as any), v196.fields[1] as any, v196.fields[2] as any, v196.fields[3] as any, v196.fields[4] as any);
    }
    else {
        return US9_US9_1(v196.fields[0] as any);
    }
}
...
export function method64(v0_mut: string, v1_mut: any, v2_mut: int32, v3_mut: int32, v4_mut: UH3_$union): US9_$union {
    method64:
    while (true) {
...
export function method65(v0_mut: UH2_$union, v1_mut: UH2_$union): UH2_$union {
    method65:
    while (true) {
...
export function method62(v0_mut: UH2_$union, v1_mut: string, v2_mut: any, v3_mut: int32, v4_mut: int32): US18_$union {
    method62:
    while (true) {
        ...
        const v121: US9_$union = ((v106.tag as int32) === /* US8_0 */ 0) ? US9_US9_0(v106.fields[0] as any, v106.fields[1] as any, v106.fields[2] as any, v106.fields[3] as any, v106.fields[4] as any) : US9_US9_1(v106.fields[0] as any);
        let v135: US9_$union;
        if ((v121.tag as int32) === /* US9_0 */ 0) {
            ...
            v135 = method64(v1, v2, v3, v4, UH3_UH3_1((arg10$0040: [string, any, int32, int32]): US9_$union => closure28(undefined, arg10$0040), UH3_UH3_1((arg10$0040_1: [string, any, int32, int32]): US9_$union => closure29(undefined, arg10$0040_1), UH3_UH3_0())));
        }
        if ((v135.tag as int32) === /* US9_0 */ 0) {
            ...
            return US18_US18_0(method65(v0, UH2_UH2_0()), v1, v2, v3, v4);
        }
        break;
    }
}

export function method66(v0: UH2_$union, v1: FSharpList<string>): FSharpList<string> {
    if ((v0.tag as int32) === /* UH2_0 */ 0) {
        return v1;
    }
    else {
        return cons(v0.fields[0] as any, method66(v0.fields[1] as any, v1));
    }
}
...
export function method59(v0_mut: UH2_$union, v1_mut: string, v2_mut: any, v3_mut: int32, v4_mut: int32): US18_$union {
    method59:
    while (true) {
        const v0: UH2_$union = v0_mut, v1: string = v1_mut, v2: any = v2_mut, v3: int32 = v3_mut, v4: int32 = v4_mut;
        const v5: boolean = "" === v1;
        ...
        let v134: US9_$union;
        if ((v114.tag as int32) === /* US8_0 */ 0) {
            const patternInput_1: [string, string, any, int32, int32] = method61(v114.fields[0] as any, v114.fields[1] as any, v114.fields[2] as any, v114.fields[3] as any, v114.fields[4] as any);
            v134 = US9_US9_0(patternInput_1[0], patternInput_1[1], patternInput_1[2], patternInput_1[3], patternInput_1[4]);
        }
        else {
            v134 = US9_US9_1(v114.fields[0] as any);
        }
        let v522: US9_$union;
        if ((v134.tag as int32) === /* US9_0 */ 0) {
            ...
            let v261: US8_$union;
            if (v5) {
                v261 = US8_US8_1(toText(interpolate("parsing.p_char / unexpected end of input / c: \'%P()\' / s: %A%P()", ["\"", [v2, v3, v4] as [any, int32, int32]])));
            }
            else {
                ...
                if (v146 === "\"") {
                    ...
                    v261 = US8_US8_0(v146, v181, patternInput_2[0], patternInput_2[1], patternInput_2[2]);
                }
                else {
                    const v202: int32 = (v1.indexOf("\n") - 1) | 0;
                    const v217 = 0;
                    const v238: int32 = (((-2 === v202) ? (v1.length + 1) : (v202 + 1)) - 1) | 0;
                    v261 = US8_US8_1(concat(`parsing.p_char / expected: '${"\""}' / line: ${v3} / col: ${v4}
${v2}${v1.slice(v217, v238 + 1)}`, "\n", method27(v4 - 1, 0)("") + "^", ..."\n"));
                }
            }
            let v451: US9_$union;
            if ((v261.tag as int32) === /* US8_0 */ 0) {
                ...
                const v268: US18_$union = method62(UH2_UH2_0(), v263, v264, v265, v266);
                let v301: US9_$union;
                if ((v268.tag as int32) === /* US18_0 */ 0) {
                    ...
                    const v275: FSharpList<string> = method66(v268.fields[0] as any, empty<string>());
                    v301 = US9_US9_0(join("", delay<string>((): Iterable<string> => v275)), v270, v271, v272, v273);
                }
                else {
                    v301 = US9_US9_1(v268.fields[0] as any);
                }
                if ((v301.tag as int32) === /* US9_0 */ 0) {
                    ...
                    let v428: US8_$union;
                    if ("" === v303) {
                        v428 = US8_US8_1(toText(interpolate("parsing.p_char / unexpected end of input / c: \'%P()\' / s: %A%P()", ["\"", [v304, v305, v306] as [any, int32, int32]])));
                    }
                    else {
                        ...
                        if (v313 === "\"") {
                            ...
                            v428 = US8_US8_0(v313, v348, patternInput_3[0], patternInput_3[1], patternInput_3[2]);
                        }
                        else {
                            const v369: int32 = (v303.indexOf("\n") - 1) | 0;
                            const v384 = 0;
                            const v405: int32 = (((-2 === v369) ? (v303.length + 1) : (v369 + 1)) - 1) | 0;
                            v428 = US8_US8_1(concat(`parsing.p_char / expected: '${"\""}' / line: ${v305} / col: ${v306}
${v304}${v303.slice(v384, v405 + 1)}`, "\n", method27(v306 - 1, 0)("") + "^", ..."\n"));
                        }
                    }
                    if ((v428.tag as int32) === /* US8_0 */ 0) {
                        const v429 = v428.fields[0] as any;
                        v451 = US9_US9_0(v302, v428.fields[1] as any, v428.fields[2] as any, v428.fields[3] as any, v428.fields[4] as any);
                    }
                    else {
                        v451 = US9_US9_1(toText(interpolate("parsing.between / expected closing delimiter / e: %A%P() / input: %A%P() / rest1: %A%P() / rest2: %A%P()", [v428.fields[0] as any, [v1, v2, v3, v4] as [string, any, int32, int32], [v263, v264, v265, v266] as [string, any, int32, int32], [v303, v304, v305, v306] as [string, any, int32, int32]])));
                    }
                }
                else {
                    const v443 = v301.fields[0] as any;
                    v451 = US9_US9_1("parsing.between / expected content");
                }
            }
            else {
                v451 = US9_US9_1(v261.fields[0] as any);
            }
            if ((v451.tag as int32) === /* US9_0 */ 0) {
                ...
                const v463: US9_$union = method64(v1, v2, v3, v4, UH3_UH3_1((arg10$0040: [string, any, int32, int32]): US9_$union => closure28(undefined, arg10$0040), UH3_UH3_1((arg10$0040_1: [string, any, int32, int32]): US9_$union => closure29(undefined, arg10$0040_1), UH3_UH3_0())));
                let v474: US9_$union;
                if ((v463.tag as int32) === /* US9_0 */ 0) {
                    const v464 = v463.fields[0] as any;
                    v474 = US9_US9_0("", v463.fields[1] as any, v463.fields[2] as any, v463.fields[3] as any, v463.fields[4] as any);
                }
                else {
                    v474 = US9_US9_1(v463.fields[0] as any);
                }
                let v485: US18_$union;
                if ((v474.tag as int32) === /* US9_0 */ 0) {
                    const v475 = v474.fields[0] as any;
                    v485 = method67(UH2_UH2_0(), v474.fields[1] as any, v474.fields[2] as any, v474.fields[3] as any, v474.fields[4] as any);
                }
                else {
                    v485 = US18_US18_1(v474.fields[0] as any);
                }
                if ((v485.tag as int32) === /* US18_0 */ 0) {
                    ...
                    const v492: FSharpList<string> = method66(v485.fields[0] as any, empty<string>());
                    v522 = US9_US9_0(join("", delay<string>((): Iterable<string> => v492)), v487, v488, v489, v490);
                }
                else {
                    v522 = US9_US9_1(v485.fields[0] as any);
                }
            }
        }
        if ((v522.tag as int32) === /* US9_0 */ 0) {
            ...
            let v571: US11_$union;
            if (0 === v529) {
                v571 = US11_US11_1("parsing.spaces1 / expected at least one space");
            }
            else {
                const v543: int32 = v529 | 0;
                const v564: int32 = (v524.length - 1) | 0;
                v571 = US11_US11_0(v524.slice(v543, v564 + 1), v525, v526, v527);
            }
            if ((v571.tag as int32) === /* US11_0 */ 0) {
                ...
                return US18_US18_0(method65(v0, UH2_UH2_1(v523, UH2_UH2_0())), v524, v525, v526, v527);
            }
        }
        else {
...
export function method58(v0: string): US17_$union {
    let _v0: Option<Option<string>> = undefined;
    _v0 = some(v0);
    const v22: US18_$union = method59(UH2_UH2_0(), defaultArg((_v0 == null) ? (() => {
        throw new Error("optionm\'.of_obj / _v0=None");
    ...
    if ((v22.tag as int32) === /* US18_0 */ 0) {
        ...
        return US17_US17_0(toArray<string>(method66(v22.fields[0] as any, empty<string>())));
    }
    else {
...
export function closure27(unitVar: void, v0: string): FSharpResult$2_$union<string[], string> {
    const v1: US17_$union = method58(v0);
