pub mod Runtime {
    ...
    pub fn method2(v0_1: string) -> string {
        panic!(
            ...
            sprintf!(
                ...
                Runtime::US4::US4_3(Runtime::US3::US3_1),
                v0_1
            ),
        )
    }
    ...
    pub fn method8(
        ...
        let v347: Runtime::US2 = defaultValue(Runtime::US2::US2_1, map(Runtime::method9(), v5));
        let v465: DateTime = match &v347 {
            Runtime::US2::US2_0(v347_0_0) => {
        ...
        let v467: string = Runtime::method10();
    ...
    pub fn method56(v0_1: LrcPtr<TaskCanceledException>) -> string {
        ...
        let v46: std::string::String = format!("{:#?}", v0_1);
        let v81: () = {
            Runtime::closure7(
                v2_1.clone(),
