pub mod Runtime {
    ...
    pub fn method46(
        ...
        let v534: std::string::String = format!("{:#?}", v5);
        let v577: () = {
            Runtime::closure7(
                v10.clone(),
        ...
        let v646: std::string::String = format!("{:#?}", v6);
        let v689: () = {
            Runtime::closure7(
                v10.clone(),
        ...
        let v831: std::string::String = format!("{:#?}", v8);
        let v874: () = {
            Runtime::closure7(
                v10.clone(),
                fable_library_rust::String_::fromString(v831),
                (),
            );
            ()
        };
    ...
    pub fn method65(
        ...
        let v536: std::string::String = format!("{:#?}", v5);
        let v579: () = {
            Runtime::closure7(
                v10.clone(),
        ...
        let v648: std::string::String = format!("{:#?}", v6);
        let v691: () = {
            Runtime::closure7(
                v10.clone(),
                fable_library_rust::String_::fromString(v648),
                (),
            );
            ()
        };
        ...
        let v833: std::string::String = format!("{:#?}", v8);
        let v876: () = {
            Runtime::closure7(
                v10.clone(),
