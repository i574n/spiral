pub mod Runtime {
    ...
    pub fn method59(
        ...
        let v169: std::string::String = format!("{:#?}", v3);
        let v198: () = {
            Runtime::closure7(
                v10.clone(),
        ...
        let v331: std::string::String = format!("{:#?}", v6);
        let v360: () = {
            Runtime::closure7(
                v10.clone(),
                fable_library_rust::String_::fromString(v331),
                (),
            );
            ()
        };
        ...
        let v430: std::string::String = format!("{:#?}", v8);
        let v459: () = {
            Runtime::closure7(
                v10.clone(),
                fable_library_rust::String_::fromString(v430),
                (),
            );
            ()
        };
