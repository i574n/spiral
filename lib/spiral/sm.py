...
def method0(v0_1: int, v1_1: str, v2_1: int) -> Callable[[str], str]:
    def _arrow6(v: str, v0_1: Any=v0_1, v1_1: Any=v1_1, v2_1: Any=v2_1) -> str:
...
def closure23(v0_1: Array[str], v1_1: str) -> Array[str]:
    v119: IEnumerable_1[str] = of_array(v0_1)
    v122: str = method4()
    return split_1(v1_1, [join(method5(v122) if (v122 == "\n") else v122, v119)], None, 0)
...
def closure45(unit_var: None, v0_1: str) -> Callable[[IEnumerable_1[str]], str]:
    def _arrow47(v: IEnumerable_1[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
def closure47(unit_var: None, v0_1: str) -> Callable[[Array[str]], str]:
    def _arrow48(v: Array[str], unit_var: Any=unit_var, v0_1: Any=v0_1) -> str:
...
v0: Callable[[str, str], bool] = _arrow49
...
v3: Callable[[int, str, str], str] = _arrow52
