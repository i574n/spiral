...
export function closure0(unitVar: void, v0_1: Option<any>): [any, IDisposable] {
    ...
    const _run_target_args$0027_v9 = [patternInput[0], patternInput[1]] as [any, IDisposable];
    return [_run_target_args$0027_v9[0], _run_target_args$0027_v9[1]] as [any, IDisposable];
}
