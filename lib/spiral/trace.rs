pub mod Trace {
    ...
    pub fn method10(v0: Trace::US0) -> string {
        ...
        let v123: &str = &*v57;
        let v154: &str = inline_colorization::color_reset;
        let v156: std::string::String = format!("{}{}{}", v116, v123, v154);
        fable_library_rust::String_::fromString(v156)
    }
