pub mod Trace {
    ...
    pub fn method6(
        ...
        let v241: Trace::US2 = defaultValue(Trace::US2::US2_1, map(Trace::method7(), v5));
        let v395: DateTime = match &v241 {
            Trace::US2::US2_0(v241_0_0) => {
    ...
    pub fn method10(v0: Trace::US0) -> string {
        let v650: string = match &v0 {
            Trace::US0::US0_1 => {
                let v133: &str = inline_colorization::color_bright_blue;
                let v140: std::string::String = String::from(v133);
                fable_library_rust::String_::fromString(v140)
            }
            Trace::US0::US0_2 => {
                let v262: &str = inline_colorization::color_bright_green;
                let v269: std::string::String = String::from(v262);
                fable_library_rust::String_::fromString(v269)
            }
            Trace::US0::US0_0 => {
                let v4: &str = inline_colorization::color_bright_black;
                let v11: std::string::String = String::from(v4);
                fable_library_rust::String_::fromString(v11)
            }
            Trace::US0::US0_3 => {
                let v391: &str = inline_colorization::color_yellow;
                let v398: std::string::String = String::from(v391);
                fable_library_rust::String_::fromString(v398)
            }
            _ => {
                let v520: &str = inline_colorization::color_bright_red;
                let v527: std::string::String = String::from(v520);
