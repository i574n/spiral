pub mod Trace {
    ...
    pub fn method10(v0: Trace::US0) -> string {
        let v650: string = match &v0 {
            Trace::US0::US0_1 => {
                let v173: &str = inline_colorization::color_bright_blue;
                let v182: std::string::String = String::from(v173);
                fable_library_rust::String_::fromString(v182)
            }
            Trace::US0::US0_2 => {
                let v302: &str = inline_colorization::color_bright_green;
                let v311: std::string::String = String::from(v302);
                fable_library_rust::String_::fromString(v311)
            }
            Trace::US0::US0_0 => {
                let v44: &str = inline_colorization::color_bright_black;
                let v53: std::string::String = String::from(v44);
                fable_library_rust::String_::fromString(v53)
            }
            Trace::US0::US0_3 => {
                let v431: &str = inline_colorization::color_yellow;
                let v440: std::string::String = String::from(v431);
                fable_library_rust::String_::fromString(v440)
            }
            _ => {
                let v560: &str = inline_colorization::color_bright_red;
                let v569: std::string::String = String::from(v560);
                fable_library_rust::String_::fromString(v569)
            }
        };
        ...
        let v755: &str = inline_colorization::color_reset;
        let v764: std::string::String = String::from(v755);
        append((v709), (fable_library_rust::String_::fromString(v764)))
    }
