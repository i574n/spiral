pub mod Trace {
    ...
    pub fn method2(v0_1: string) -> string {
        panic!(
            ...
            sprintf!(
                ...
                Trace::US4::US4_3(Trace::US3::US3_1),
                v0_1
            ),
        )
    }
    ...
    pub fn method7(
        ...
        let v341: Trace::US2 = defaultValue(Trace::US2::US2_1, map(Trace::method8(), v5));
        let v459: DateTime = match &v341 {
            Trace::US2::US2_0(v341_0_0) => {
    ...
    pub fn method11(v0_1: Trace::US0) -> string {
        ...
        let v177: std::string::String = format!("{}{}{}", v140, v149, v175);
